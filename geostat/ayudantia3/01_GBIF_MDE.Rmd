...
> En caso de que para su trabajo necesiten descargar volumenes de datos
> superiores a 100.000, la forma más robusta es usar occ_download().
> Para implementarla es necesario tener una cuenta en GBif y usar el
> paquete `rgbif`.

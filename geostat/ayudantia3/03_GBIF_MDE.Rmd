...
Bioclim_futuro <- rast("Bioclim_futuro.tif") 
names(Bioclim_futuro) <- names(Bioclim)
...
Prediccion para condiciones futuras
```{r glm_prediccion, echo=TRUE}
predictions <- predict(Bioclim_futuro[[names(var_ambientales)]], modelo_glm, type = "response")

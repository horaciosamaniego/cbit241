...
#   var = "bio",                # Variables bioclimáticas
#   res = 0.5,                  # Resolución (en minutos: 10, 5, 2.5)
#   ssp = "ssp245",             # Escenario: ssp126, ssp245, ssp370, ssp585
#   model = "BCC-CSM2-MR",      # Modelo climático (hay muchos disponibles)
#   time = "2041-2060",         # Periodo
#   path = getwd()              # Carpeta de descarga
# )
# 
# names(Bioclim_futuro) <- sapply(strsplit(names(Bioclim_futuro), split='30s_', fixed=TRUE), function(x) (x[2])) # renombra columnas
# names(Bioclim_futuro) <- sapply(gsub('_','',names(Bioclim_futuro)), function(x) (x))
# 
# plot(Bioclim_futuro)
```
